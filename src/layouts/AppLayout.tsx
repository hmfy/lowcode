...
const iconMap = {
  ...
  warnings: <WarningOutlined />,
  providers: <ApiOutlined />,
  'ui-data': <TableOutlined />,
  'ui-forms': <FormOutlined />,
  'ui-feedback': <AppstoreAddOutlined />,
  'ui-pages': <FileTextOutlined />
};
    ...
    <Layout className="app-shell">
      <Layout.Sider
        ...
        <Link to="/" className="brand">
          ...
          {!collapsed && <span>Best Lowcode</span>}
        </Link>
        <Menu
          theme="dark"
          mode="inline"
